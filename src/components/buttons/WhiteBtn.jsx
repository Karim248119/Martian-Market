...
export default function WhiteBtn({ title, className, onClick, removeIcon }) {
  return (
    ...
    >
      <span className="bg-white w-52 h-52 absolute -top-48 -left-48 rotate-45 group-hover:top-1/2 group-hover:left-1/2 group-hover:-translate-x-1/2 group-hover:-translate-y-1/2 duration-300"></span>
